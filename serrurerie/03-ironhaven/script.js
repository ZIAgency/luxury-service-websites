/* ═══════════════════════════════════════════
   IRONHAVEN & SONS — interactions
   nav · embers · reveal · counters · timeline · contact · wizard
   ═══════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  /* ── Forge embers: scatter once, CSS keeps them rising ── */
  var emberWrap = document.querySelector('.hero-embers');
  if (emberWrap && !reducedMotion) {
    emberWrap.querySelectorAll('span').forEach(function (s) {
  ...
  /* ── Generational timeline: light the line as it arrives ── */
  ...
  /* ── Founder's key: gentle draw of the stamp on hover ── */
  var plaque = document.querySelector('.hero-plaque');
  if (plaque && !reducedMotion) {
    plaque.addEventListener('pointerenter', function () {
      plaque.classList.add('held');
    });
    plaque.addEventListener('pointerleave', function () {
      plaque.classList.remove('held');
    });
  }
