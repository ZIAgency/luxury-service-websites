/* ═══════════════════════════════════════════
   NOVA SMILE LAB — interactions
   nav · reveal · counters · contact · wizard
   ═══════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  /* ── Shade chip selection (visual feedback in preview mock) ── */
  document.querySelectorAll('.shade-row .shade').forEach(shade => {
    shade.addEventListener('click', () => {
      document.querySelectorAll('.shade-row .shade').forEach(s => s.classList.remove('sel'));
      shade.classList.add('sel');
    });
  });
